...
def main():
    ...
    params = EKFParams(
        ...
        # drag_y=3.09,
        # drag_z=0.297181,
        # flow_std_fixed_x=1.65,
        # flow_std_fixed_y=5.5,
        #  flow_std_fixed=2.69351,
        # tof_exp_std_a=0.000842223,
        # proc_noise_acc_xy=1.41688,
        # proc_noise_acc_z=1.02161,
        # meas_noise_gyro_rp=0.029438,
        # meas_noise_gyro_yaw=0.0307811,
        # drag_x=4.42318,
        # drag_y=2.41966,
        # drag_z=0.895705,
        # flow_std_fixed_x=0.965828,
        # flow_std_fixed_y=3.92004,
        # tof_exp_std_a=0.00458557,
        # flow_resolution=0.2
