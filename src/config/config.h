...
#define ADHOC_DECK_OLSR_RX_TASK_NAME "ADHOC_OLSR_RX"
#define ADHOC_DECK_RAFT_RX_TASK_NAME "ADHOC_RAFT_RX"
#define ADHOC_DECK_RAFT_COMMAND_BUFFER_CONSUME_TASK_NAME "ADHOC_RAFT_COMMAND_BUFFER_CONSUME"
